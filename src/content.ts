...
export type Artifact = {
  ...
  title: string
  kicker: string
  theme: 'indus' | 'sanchi' | 'gupta' | 'ajanta' | 'chola' | 'mughal' | 'ravivarama' | 'bengal'
  chapter: string
  region: string
  medium: string
  collection: string
...
export const artifacts: Artifact[] = [
  {
    id: 'dancing-girl', year: 'c. 2500 BCE', era: 'INDUS VALLEY', title: 'Dancing Girl of Mohenjo-daro', kicker: 'The first spark', theme: 'indus', chapter: 'The city remembers her', region: 'Mohenjo-daro, Sindh', medium: 'Cast bronze', collection: 'National Museum, New Delhi', image: '/images/dancing-girl.jpg', imagePosition: 'center', accent: '#e96f3d',
    ...
    gallery: [
      { src: '/gallery/indus-seals.jpg', title: 'Indus Valley seals', credit: 'Wikimedia Commons', sourceUrl: 'https://commons.wikimedia.org/wiki/File:IndusValleySeals.JPG' },
      { src: '/gallery/mohenjodaro-stupa.jpg', title: 'Buddhist stupa at Mohenjo-daro', credit: 'Wikimedia Commons', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Buddhist_stupa,_Mohenjo-daro.JPG' },
    ],
  },
  {
    id: 'sanchi', year: 'c. 1st BCE–1st CE', era: 'SHUNGA · SATAVAHANA', title: 'Sanchi Stupa gateway relief', kicker: 'Stories in stone', theme: 'sanchi', chapter: 'Walk the story clockwise', region: 'Sanchi, Madhya Pradesh', medium: 'Carved sandstone', collection: 'Great Stupa No. 1, Sanchi', image: '/images/sanchi-gateway.jpg', companionImage: '/images/sanchi-torana.jpg', companionAlt: 'The north gateway of the Great Stupa at Sanchi', imagePosition: 'center', accent: '#dfb34e',
    ...
    gallery: [
      { src: '/gallery/sanchi-stupa.jpg', title: 'Great Stupa No. 1, Sanchi', credit: 'Wikimedia Commons', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Stupa_1,_Sanchi_02.jpg' },
      { src: '/gallery/ashoka-pillar.jpg', title: 'Ashoka pillar at Sanchi', credit: 'Wikimedia Commons', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Ashoka%E2%80%99s_Pillar_at_Sanchi_Stup_(2).jpg' },
    ],
  },
  {
    id: 'buddha', year: 'Early 5th century CE', era: 'GUPTA', title: 'Seated Buddha', kicker: 'A language of serenity', theme: 'gupta', chapter: 'Stillness made visible', region: 'Uttar Pradesh', medium: 'Sandstone', collection: 'The Metropolitan Museum of Art', image: '/images/seated-buddha.jpg', imagePosition: 'center', accent: '#c87554',
    ...
    gallery: [
      { src: '/gallery/gupta-buddha.jpg', title: 'Gupta Buddha from Sarnath', credit: 'Wikimedia Commons', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Periodo_gupta,_buddha,_da_sarnath,_300-600_dc_ca.jpg' },
    ],
  },
  {
    id: 'padmapani', year: 'c. 5th century CE', era: 'VAKATAKA', title: 'Padmapani, Ajanta Cave 1', kicker: 'A painted world', theme: 'ajanta', chapter: 'A cave becomes a universe', region: 'Ajanta, Maharashtra', medium: 'Mural painting', collection: 'Ajanta Caves, Cave 1', image: '/images/padmapani.jpg', imagePosition: '45% center', accent: '#7b9b81',
    ...
    gallery: [
      { src: '/gallery/ajanta-padmapani-detail.jpg', title: 'Padmapani, alternate view', credit: 'Wikimedia Commons', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Bodhisattva_Padmapani,_cave_1,_Ajanta,_India.jpg' },
    ],
  },
  {
    id: 'nataraja', year: '10th–11th century CE', era: 'CHOLA', title: 'Shiva as Nataraja', kicker: 'The cosmos dances', theme: 'chola', chapter: 'A universe in motion', region: 'Tamil Nadu', medium: 'Cast bronze', collection: 'Art Institute of Chicago', image: '/images/nataraja.jpg', imagePosition: 'center', accent: '#f4aa4f',
    ...
    gallery: [
      { src: '/gallery/chennai-nataraja.jpg', title: 'Nataraja in the Government Museum, Chennai', credit: 'Wikimedia Commons', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Nataraja_Bronze_in_Government_Museum,_Chennai.jpg' },
    ],
  },
  {
    id: 'jahangir', year: '1615–1618', era: 'MUGHAL', title: 'Jahangir Preferring a Sufi Shaikh to Kings', kicker: 'Power, painted precisely', theme: 'mughal', chapter: 'The album holds a court', region: 'Mughal court, North India', medium: 'Opaque watercolour, ink & gold on paper', collection: 'Freer Gallery of Art', image: '/images/jahangir.jpg', companionImage: '/images/bichitr-detail.png', companionAlt: 'Detail of Bichitr self portrait in the Jahangir painting', imagePosition: 'center', accent: '#9d6370',
    ...
    gallery: [
      { src: '/gallery/akbar-tansen.jpg', title: 'Akbar and Tansen visit Haridas', credit: 'Wikimedia Commons', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Akbar_and_Tansen_visit_Haridas.jpg' },
    ],
  },
  {
    id: 'shakuntala', year: '1870', era: 'COLONIAL MODERNITY', title: 'Shakuntala and her companions', kicker: 'Myth, made modern', theme: 'ravivarama', chapter: 'Drama enters the canvas', region: 'Travancore / Bombay', medium: 'Oil painting', collection: 'Raja Ravi Varma oeuvre', image: '/images/shakuntala.jpg', imagePosition: 'center', accent: '#af6641',
    ...
    gallery: [
      { src: '/gallery/galaxy-musicians.jpg', title: 'Galaxy of Musicians', credit: 'Wikimedia Commons', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Raja_Ravi_Varma,_Galaxy_of_Musicians.jpg' },
    ],
  },
  {
    id: 'bharat-mata', year: '1905', era: 'BENGAL SCHOOL', title: 'Bharat Mata', kicker: 'An idea takes form', theme: 'bengal', chapter: 'A nation in a wash of colour', region: 'Kolkata, Bengal', medium: 'Watercolour on paper', collection: 'Victoria Memorial Hall, Kolkata', image: '/images/bharat-mata.jpg', imagePosition: 'center', accent: '#d77f3a',
    ...
    gallery: [
      { src: '/gallery/abhisarika.jpg', title: 'Abhisarika', credit: 'Wikimedia Commons', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Abhisarika_by_Abanindranath_Tagore.jpg' },
    ],
  },
]
